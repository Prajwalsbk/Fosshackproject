...
$designationFilter = "Environmental & Renewable Energy Schemes";  
$schemes = [];
...
<head>
    ...
    <title>Environmental & Renewable Energy Schemes</title>
...
<body>
    <div class="container">
        <h2 class="mb-4">Environmental & Renewable Energy Schemes</h2>
        ...
        <?php else : ?>
            <p class="text-danger">No Environmental & Renewable Energy Schemes available at the moment.</p>
        <?php endif; ?>
