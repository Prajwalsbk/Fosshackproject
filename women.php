...
$designationFilter = "Women Empowerment & Child Welfare";  
$schemes = [];
...
<head>
    ...
    <title>Women Empowerment & Child Welfare</title>
...
<body>
    <div class="container">
        <h2 class="mb-4">Women Empowerment & Child Welfare</h2>
        ...
        <?php else : ?>
            <p class="text-danger">No Women Empowerment & Child Welfare available at the moment.</p>
        <?php endif; ?>
