...
$designationFilter = "Minority & SC/ST Welfare Schemes";  
$schemes = [];
...
<head>
    ...
    <title>Minority & SC/ST Welfare Schemes</title>
...
<body>
    <div class="container">
        <h2 class="mb-4">Minority & SC/ST Welfare Schemes</h2>
        ...
        <?php else : ?>
            <p class="text-danger">No Minority & SC/ST Welfare Schemes available at the moment.</p>
        <?php endif; ?>
