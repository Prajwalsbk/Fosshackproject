...
$designationFilter = "Housing & Urban Development Schemes";  
$schemes = [];
...
<body>
    <div class="container">
        <h2 class="mb-4">Housing & Urban Development Schemes</h2>
        ...
        <?php else : ?>
            <p class="text-danger">No Housing & Urban Development Schemes available at the moment.</p>
        <?php endif; ?>
