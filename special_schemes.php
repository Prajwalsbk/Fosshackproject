...
$designationFilter = "Special Schemes for Specific Sectors";  
$schemes = [];
...
<head>
    ...
    <title>Special Schemes for Specific Sectors</title>
...
<body>
    <div class="container">
        <h2 class="mb-4">Special Schemes for Specific Sectors</h2>
        ...
        <?php else : ?>
            <p class="text-danger">No Special Schemes for Specific Sectors available at the moment.</p>
        <?php endif; ?>
