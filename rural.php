...
$designationFilter = "Rural Development Schemes";  // Match exactly with database
$schemes = [];
...
<head>
    ...
    <title>Rural Development Schemes</title>
...
<body>
    <div class="container">
        <h2 class="mb-4">Rural Development Schemes</h2>
        ...
        <?php else : ?>
            <p class="text-danger">No Rural Development Schemes available at the moment.</p>
        <?php endif; ?>
